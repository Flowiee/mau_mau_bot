...
SCORE_WIN = config.get("score_mode_win_score", 250)
SCORE_DUEL = config.get("score_mode_win_duel", 50)
ADDITIONAL_POINT = config.get("score_mode_win_per_player_additional", 50)
